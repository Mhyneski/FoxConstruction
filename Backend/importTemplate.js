  ...
  const baseTemplate = {
    ...
    bom: {
      ...
      materials: [
        ...
        { item: '3.1.1', description: 'Non-skid floor tile (20cm x 20cm) - *Basic Ceramic Tile* ', category: 'Architectural - Tiles', quantity: 158, unit: 'pcs', unitCost: 17, totalAmount: 2686 },
        { item: '3.1.2', description: 'Toilet Wall Tile (20cm x 20cm) - *Standard White Ceramic Tile* ', category: 'Architectural - Tiles', quantity: 473, unit: 'pcs', unitCost: 17, totalAmount: 8041 },
        { item: '3.1.3', description: 'Tile Adhesive - *Standard Grade*', category: 'Architectural - Tiles', quantity: 3, unit: 'bags', unitCost: 250, totalAmount: 750 },
        { item: '3.1.4', description: 'Tile Grout - *Standard Grade*', category: 'Architectural - Tiles', quantity: 12, unit: 'bags', unitCost: 45, totalAmount: 540 },
        ...
        { item: '3.2.1', description: 'Masonry Neutralizer - *Basic Brand*', category: 'Architectural - Painting', quantity: 25, unit: 'gal', unitCost: 175, totalAmount: 4375 },
        { item: '3.2.2', description: 'Acrylic Gloss Latex - *Low-Grade Paint*', category: 'Architectural - Painting', quantity: 39, unit: 'gal', unitCost: 460, totalAmount: 17940 },
        { item: '3.2.3', description: 'Latex Colors - *Limited Color Palette*', category: 'Architectural - Painting', quantity: 156, unit: 'liters', unitCost: 150, totalAmount: 23400 },
        ...
        { item: '3.2.5', description: 'Paint Brush - *Basic Quality*', category: 'Architectural - Painting', quantity: 5, unit: 'pcs', unitCost: 50, totalAmount: 250 },
        { item: '3.2.6', description: 'Painters Tape - *Standard Tape*', category: 'Architectural - Painting', quantity: 4, unit: 'pcs', unitCost: 100, totalAmount: 400 },
        { item: '3.2.7', description: 'Rags - *Basic Quality*', category: 'Architectural - Painting', quantity: 20, unit: 'pcs', unitCost: 3, totalAmount: 60 },
        { item: '3.2.8', description: 'Drop Cloth - *Basic Cloth*', category: 'Architectural - Painting', quantity: 4, unit: 'pcs', unitCost: 150, totalAmount: 600 },
        { item: '3.2.9', description: 'Miscellaneous - *Basic Supplies*', category: 'Architectural - Painting', quantity: 1, unit: 'lot', unitCost: 3000, totalAmount: 3000 },

        // Roofing Works
        { item: '4.1', description: 'Trusses and Purlins', category: 'Roofing', quantity: 1, unit: 'lot', unitCost: 135000, totalAmount: 135000 },
        { item: '4.2.1', description: 'Pre-painted Metal Roof - *Thinner Gauge Metal*', category: 'Roofing', quantity: 20, unit: 'sheets', unitCost: 1200, totalAmount: 24000 },
        { item: '4.2.2', description: 'Pre-painted Gutter - *Standard Gutter*', category: 'Roofing', quantity: 8, unit: 'pcs', unitCost: 305, totalAmount: 2440 },
        { item: '4.2.3', description: 'End Flashing - *Standard Flashing*', category: 'Roofing', quantity: 8, unit: 'pcs', unitCost: 323, totalAmount: 2584 },
        { item: '4.2.4', description: 'Tekscrew - *Standard Quality*', category: 'Roofing', quantity: 9, unit: 'kgs', unitCost: 250, totalAmount: 2250 },
        { item: '4.2.5', description: 'Hipped Roll - *Standard Quality*', category: 'Roofing', quantity: 10, unit: 'pcs', unitCost: 261, totalAmount: 2610 },

        // Doors and Windows
        { item: '5.1.1', description: 'Solid Wooden Panel Door, Jamb and Accessories - *Basic Wood Type*', category: 'Doors and Windows', quantity: 1, unit: 'set', unitCost: 5000, totalAmount: 5000 },
        { item: '5.1.2', description: 'Fabricated Flush Door, Jamb and Accessories - *Basic Plywood*', category: 'Doors and Windows', quantity: 5, unit: 'set', unitCost: 3500, totalAmount: 17500 },
        { item: '5.1.3', description: 'Polyvinyl Chloride Door with Louver, Jamb and Accessories - *Standard PVC*', category: 'Doors and Windows', quantity: 1, unit: 'set', unitCost: 1500, totalAmount: 1500 },
        { item: '5.1.4', description: 'Aluminum Sliding Door and Accessories - *Standard Aluminum*', category: 'Doors and Windows', quantity: 1, unit: 'set', unitCost: 15000, totalAmount: 15000 },
        { item: '5.2.1', description: '1.4m x 1.2m (H) Aluminum Sliding Window - *Standard Aluminum*', category: 'Doors and Windows', quantity: 1, unit: 'set', unitCost: 9899.35, totalAmount: 9899.35 },
        { item: '5.2.2', description: '1.5m x 0.5m (H) Aluminum Awning Window - *Standard Quality*', category: 'Doors and Windows', quantity: 1, unit: 'set', unitCost: 1479, totalAmount: 1479 },
        { item: '5.2.3', description: '1.6m x 1.2m (H) Aluminum Sliding Window - *Standard Aluminum*', category: 'Doors and Windows', quantity: 6, unit: 'set', unitCost: 11306.9, totalAmount: 67841.28 },
        { item: '5.2.4', description: '0.5m x 0.5m (H) Aluminum Awning Window - *Standard Quality*', category: 'Doors and Windows', quantity: 1, unit: 'set', unitCost: 493, totalAmount: 493 },
